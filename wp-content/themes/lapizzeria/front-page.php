		...
		<div class="hero" style="background-image: url(<?php echo get_the_post_thumbnail_url(); ?>);">
			<div class="contenido-hero">
				<div class="texto-hero">
					<h1><?php echo esc_html(get_option('blogdescription')); //descripcion corta de ajustes?></h1> 
					<?php the_content(); ?>
	...
	<?php endwhile ?>
		...
		<div class="principal contenedor">
			<main class="contenedor-grid">
				<h2 class="rojo texto-centrado">Nuestras Espacialidades</h2>
				<?php $args = array(
						'posts_per_page' => 3,
						'orderby' => 'rand',
		...
		<section class="contenedor">
			<h2 class="texto-rojo texto-centrado">Galeria de Imágenes</h2>
